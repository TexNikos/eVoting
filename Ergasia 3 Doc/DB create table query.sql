...
ALTER TABLE tbl_candidate ADD CONSTRAINT FKtbl_candid239677 FOREIGN KEY (fk_electoral_periphery_id) REFERENCES tbl_electoral_periphery (pk_electoral_periphery_id);
